...
const Sidebar = () => {
  ...
  return (
    <>
      <div className=" fixed flex w-full lg:min-w-fit border-blue-600 md:w-1/12 lg:max-w-[130px] md:min-h-screen h-[50px] z-10 md:h-full bg-gray-700 md:flex-col md:pt-6 md:justify-between md:p-4">
